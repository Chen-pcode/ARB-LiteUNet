...
if __name__ == '__main__':
    ...
    input_path = '/data1/users/caojiarui/cjr/LB-UNet/data/isic2018/train/masks'
    output_path = '/data1/users/caojiarui/cjr/LB-UNet/data/isic2018/train/points4'
    output_path2 = '/data1/users/caojiarui/cjr/LB-UNet/data/isic2018/train/points4'
    ...
    for _id, file in enumerate(files):
        ...
        if os.path.exists(os.path.join(output_path2, file)):
            continue
        print(f"Processing file {_id + 1}/{len(files)}: {file}")
        ...
        def select_animal(animals, fitness):
            fitness = np.maximum(fitness, 0)  # 将负值修正为0
