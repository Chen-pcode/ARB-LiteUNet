...
class GT_BceDiceLoss(nn.Module):
    ...
    def forward(self, gt_pre, key_points, out, target, points):
        ...
        boundary1, boundary2, boundary3 = key_points
        boundary_loss =  0.1 * self.bcedice2(boundary3, points) + 0.2 * self.bcedice2(boundary2, points) + 0.3 * self.bcedice2(boundary1, points)
