...
class setting_config:
    ...
    datasets = 'isic17' 
    if datasets == 'isic18':
        data_path = '/data1/users/caojiarui/cjr/LDEB-UNet/data/isic2018/'
    elif datasets == 'isic17':
        data_path = '/data1/users/caojiarui/cjr/LDEB-UNet/data/isic2017/'
    elif datasets == 'isic':
        data_path = '/data1/users/caojiarui/cjr/LDEB-UNet/data/isic/'
    else:
